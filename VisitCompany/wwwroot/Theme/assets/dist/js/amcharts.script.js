...
// Add simple bullet
   ...
   /********** Serpentine chart **********/
    ...
    if (timeline_serpentine) {
        ...
        var chart1 = am4core.create("timeline_serpentine", am4plugins_timeline.SerpentineChart);
        chart1.curveContainer.padding(20, 20, 20, 20);
        chart1.levelCount = 8;
        chart1.orientation = "horizontal";
        chart1.fontSize = 11;
        chart1.rtl = true;
        ...
        chart1.dateFormatter.dateFormat = "yyyy-MM-dd";
        ...
        var series1 = chart1.series.push(new am4plugins_timeline.CurveColumnSeries());
        ...
        chart1.scrollbarX.align = "center"
        chart1.scrollbarX.width = am4core.percent(90);
