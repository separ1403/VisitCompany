...
/////////////////////////////////// Bitcoin Chart /////////////////////
    ...
    var tour = new Tour({
        steps: [
            {
                placement: "bottom",
                element: "#tourfirst",
                title: "عنوان مراحل من",
                content: "محتویات مراحل من"
            },
            {
                placement: "bottom",
                element: "#options",
        ...
        template: "<div class='popover tour bg-primary border-0'>" +
                ...
                "  <button class='btn btn-primary' data-role='prev'>&laquo; قبلی</button>" +
                "<button class='btn btn-primary mx-1' data-role='end'>پایان آموزش</button>" +
                "  <button class='btn btn-primary' data-role='next'>بعدی &raquo;</button>" +
                "</div>" +
                " </div>"});
