...
namespace VisitCompany.Pages.Users
{
  ...
  //  [Authorize]
    public class LicenceCategoriesModel : PageModel
    {
        public LicenceCategoriesModel(ILicenceCategoryApplication licenceCategoryApplication, ICompanyApplication companyApplication, ICompanyCategoryApplication companyCategoryApplication)
        {
