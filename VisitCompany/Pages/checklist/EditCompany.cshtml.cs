...
namespace ServiceHost.Areas.Administration.Pages.Shop.Products
{
    ...
    public class EditCompanyModel : PageModel
    {
        ...
        public EditCompanyModel(ICompanyApplication companyApplication, ICompanyCategoryApplication companyCategoryApplication, ILicenceCategoryApplication licenceCategoryApplication, IAccountApplication accountApplication, IStatecategoryApplication statecategoryApplication)
        {
